...
fn get_table_index(src: piece_rotation::PieceRotation, dst: piece_rotation::PieceRotation) -> usize {
    (src as usize).shl(2) | dst as usize
}

pub fn get_kick_table(piece_type: piece_type::PieceType, src: piece_rotation::PieceRotation, dst: piece_rotation::PieceRotation) -> KickTableT {
