...
num_norm_kicks = 5 # TODO: use this instead of the hardcoded value in tetris.py

all0_2 = [(0, 0), ( 1, 0), ( 2, 0), ( 1,  1), ( 2,  1), (-1,  0), (-2,  0), (-1,  1), (-2,  1), ( 0, -1), ( 3, 0), (-3,  0)]
allR_L = [(0, 0), ( 0, 1), ( 0, 2), (-1,  1), (-1,  2), ( 0, -1), ( 0, -2), (-1, -1), (-1, -2), ( 1,  0), ( 0, 3), ( 0, -3)]
all2_0 = [(0, 0), (-1, 0), (-2, 0), (-1, -1), (-2, -1), ( 1,  0), ( 2,  0), ( 1, -1), ( 2, -1), ( 0,  1), (-3, 0), ( 3,  0)]
allL_R = [(0, 0), ( 0, 1), ( 0, 2), ( 1,  1), ( 1,  2), ( 0, -1), ( 0, -2), ( 1, -1), ( 1, -2), (-1,  0), ( 0, 3), ( 0, -3)]

iwk0_2 = [(0, 0), (-1, 0), (-2, 0), ( 1,  0), ( 2,  0), ( 0,  1)]
iwkR_L = [(0, 0), ( 0, 1), ( 0, 2), ( 0, -1), ( 0, -2), (-1,  0)]
iwk2_0 = [(0, 0), ( 1, 0), ( 2, 0), (-1,  0), (-2,  0), ( 0, -1)]
iwkL_R = [(0, 0), ( 0, 1), ( 0, 2), ( 0, -1), ( 0, -2), ( 1,  0)]
